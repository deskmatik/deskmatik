...
Now, when the ESP is connected to your local network you can navigate to IP (either static IP configured in config.h or provided by DHCP) and controll the desk using web interface.
